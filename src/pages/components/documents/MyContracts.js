...
import contracts from "../../../database/contracts";
import EditMyContract from "../editcontract/EditMyContract";
      ...
      <ScrollView>
        <View>
          <Text style={styles.title}>
            {item.title} n°{item.contractNumber}
          </Text>
        ...
        <View style={styles.icon}>
          ...
          <TouchableOpacity
            style={styles.touchable}
            onPress={() => navigation.navigate("Modifier mon contrat")}
          >
            <Ionicons name="create-outline" size={40} color="#08004e" />
...
function ContractStackScreen() {
  return (
    <ContractStack.Navigator>
      ...
      <ContractStack.Screen
        options={{ headerShown: false }}
        name="Modifier mon contrat"
        component={EditMyContract}
      />
    </ContractStack.Navigator>
  );
}
export default ContractStackScreen;
